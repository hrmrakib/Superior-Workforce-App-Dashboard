      ...
      <div className='lg:col-span-2 space-y-6'>
        ...
        <div className='bg-white rounded-xl border border-slate-200 p-6'>
          ...
          <p className='text-sm text-slate-600 leading-relaxed'>
            If this shift is canceled within 8 hours of the start time, it will
            not be paid out.
          </p>
        </div>
      ...
      <div className='space-y-6'>
        ...
        <div className='bg-white rounded-xl border border-slate-200 p-6'>
          ...
          <div className='p-4 border border-slate-100 rounded-xl text-sm text-slate-600 leading-relaxed bg-slate-50/50'>
            Focus on cleanliness and sanitation. Use proper cleaning supplies
            and follow facility-specific hygiene protocols.
          </div>
        </div>
