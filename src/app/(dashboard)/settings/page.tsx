...
import { Upload, Lock, Eye, EyeOff, ShieldCheck, Users, ChevronDown } from "lucide-react";

type TabType = "Profile Info" | "Change Password" | "Edit Terms & Policies" | "Edit About Us";
  ...
  return (
    <div className="p-6">
      ...
      <div className="space-y-5">
        <div>
          <label className="block text-xs font-medium text-slate-700 mb-2">Old Password</label>
          <div className="relative">
...
function EditTermsTab() {
  const defaultText = "We value your privacy and are committed to protecting your personal information. Our platform collects essential data such as your profile details, professional credentials, and communication activity to provide a secure and efficient job-matching experience. All information is stored securely and used only to improve our services, verify user authenticity, and facilitate connections between healthcare professionals and employers. We do not sell or share your personal data with third parties without your consent, except when required by law. By using our app, you agree to our data practices designed to ensure safety, transparency, and trust.";
