  ...
  const renderLeftContent = () => {
      ...
      return (
        <div className="flex flex-col">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl lg:text-2xl font-bold text-slate-800 leading-none">Jobs Details</h1>
          </div>
          <p className="text-xs lg:text-sm text-slate-500 ml-8 mt-1 leading-none">Upcoming</p>
        </div>
      );
    }
      ...
      return (
        <div className="flex flex-col">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl lg:text-2xl font-bold text-slate-800 leading-none">Create Notifications</h1>
          </div>
          <p className="text-xs lg:text-sm text-slate-500 ml-8 mt-1 leading-none">You can create a new notifications</p>
        </div>
      );
    }
    if (pathname === "/send-notification") {
      return (
        <div className="flex flex-col">
          <div className="flex items-center gap-3">
            <h1 className="text-xl lg:text-2xl font-bold text-slate-800 leading-none">Send Notifications</h1>
          </div>
          <p className="text-xs lg:text-sm text-slate-500 mt-1 leading-none">You can send and create a new notifications</p>
        </div>
      );
    }
    if (pathname === "/support-report") {
      return (
        <div className="flex flex-col">
          <div className="flex items-center gap-3">
            <h1 className="text-xl lg:text-2xl font-bold text-slate-800 leading-none">Support</h1>
          </div>
          <p className="text-xs lg:text-sm text-slate-500 mt-1 leading-none">Some support requests have come to you. Please reply to them.</p>
        </div>
      );
    }
      ...
      <div className="flex items-center gap-2 lg:gap-3">
        ...
        <div className="flex items-center gap-2.5">
          <div className="text-right hidden sm:block">
            <p className="text-sm font-semibold text-slate-800 leading-none">Aiden Max</p>
          </div>
